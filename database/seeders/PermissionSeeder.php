...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roleDefinitions = [
            ...
            'hr_manager' => [
                'label' => 'HR Manager',
                'names' => ['view_employees', 'view_employee_sensitive', 'manage_employees', 'suspend_employees', 'view_departments', 'manage_departments', 'view_positions', 'manage_positions', 'view_attendance', 'manage_attendance', 'view_own_attendance', 'view_leave', 'manage_leave', 'approve_leave', 'view_own_leave', 'request_leave', 'view_payroll', 'view_own_payslip', 'view_reimbursement', 'manage_reimbursement', 'approve_reimbursement', 'view_own_claims', 'submit_claim', 'view_shifts', 'manage_shifts', 'view_own_schedule', 'manage_overtime', 'approve_overtime', 'view_own_overtime', 'request_overtime', 'view_performance', 'manage_performance', 'view_own_appraisal', 'view_recruitment', 'manage_recruitment', 'manage_candidates', 'view_settings', 'manage_settings', 'view_reports', 'view_dashboard_admin'],
            ],
            'hr_staff' => [
                'label' => 'HR Staff',
            ...
            'payroll_specialist' => [
                ...
                'names' => ['view_payroll', 'manage_payroll', 'view_own_payslip', 'view_settings', 'view_employees', 'view_reports'],
            ],
            'executive' => [
                'label' => 'Executive',
                'names' => ['view_reports', 'view_dashboard_admin', 'view_employees', 'view_payroll', 'view_attendance', 'view_leave', 'view_performance', 'view_recruitment'],
            ],
            'recruiter' => [
                'label' => 'Recruiter',
            ...
            'it_admin' => [
                'label' => 'IT Admin',
                'names' => ['view_users', 'manage_users', 'manage_roles', 'view_settings', 'manage_settings', 'view_employees', 'view_departments', 'view_positions', 'view_own_attendance', 'view_own_leave', 'request_leave', 'view_own_payslip', 'view_own_claims', 'submit_claim', 'view_own_schedule', 'view_own_overtime', 'request_overtime', 'view_own_appraisal'],
            ],
            'employee' => [
                'label' => 'Employee',
