    ...
    <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            <div class="flex items-center gap-2 text-sm text-gray-500">
                ...
                <span class="text-gray-900">Create Department</span>
            </div>
            <h1 class="mt-2 text-2xl font-bold text-gray-900">Create Department</h1>
        </div>

        <form action="{{ route('departments.store') }}" method="POST" class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5">
            @csrf
            ...
            <div class="mt-6 flex items-center justify-end gap-3 border-t border-gray-100 pt-6">
                ...
                <button type="submit" class="rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500">Create Department</button>
            </div>
        </form>
    </div>
</div>
