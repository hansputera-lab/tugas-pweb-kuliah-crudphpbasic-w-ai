...
<div class="py-6">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Reimbursement Claims</h1>
                <p class="mt-1 text-sm text-gray-500">Review and approve employee expense claims</p>
            </div>
            <a href="{{ route('reimbursements.categories') }}" class="inline-flex items-center rounded-lg bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500">
                Manage Categories
            </a>
        </div>
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white">
                        @forelse($claims as $claim)
                            <tr class="hover:bg-gray-50">
                                <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">{{ $claim->employee->full_name ?? '-' }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="px-6 py-12 text-center text-sm text-gray-500">No reimbursement claims found</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
