        ...
        <form action="{{ route('recruitment.update', $posting->id) }}" method="POST" class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="salary_min" id="salary_min" value="{{ old('salary_min', $posting->salary_min) }}" data-currency
                           class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <input type="text" name="salary_max" id="salary_max" value="{{ old('salary_max', $posting->salary_max) }}" data-currency
                           class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
