...
<div class="py-6">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-gray-500">Manage employee attendance records</p>
        </div>

        {{-- Filters --}}
        <div class="mb-6 rounded-xl bg-white p-4 shadow-sm ring-1 ring-gray-950/5">
            <form action="{{ route('attendance.index') }}" method="GET" class="flex flex-col gap-4 sm:flex-row sm:items-end">
                ...
                <div class="flex-1">
                    ...
                    <select name="employee_id" id="employee_id" class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('attendance.index') }}" class="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">Reset</a>
                </div>
            </form>
        </div>
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white">
                        @forelse($attendances ?? [] as $att)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900">{{ $att->employee->full_name ?? '-' }}</td>
