...
REM ============================================
echo [HRIS] Initializing MariaDB...
...
echo [HRIS] MariaDB data directory initialized.

REM ============================================
REM Step 2: Generate random DB password
REM ============================================
echo [HRIS] Generating database password...
setlocal
...
echo [HRIS] MariaDB PID: !MYSQL_PID!
...
echo [HRIS] MariaDB is ready.

REM ============================================
REM Step 4: Create database and user
REM ============================================
echo [HRIS] Creating database and user...
...
echo [HRIS] Database configured.

REM ============================================
REM Step 5: Configure .env
REM ============================================
echo [HRIS] Configuring .env...
cd /d "%HRIS_DIR%"
...
REM ============================================
echo [HRIS] Running Laravel setup...
cd /d "%HRIS_DIR%"

REM Generate app key
php artisan key:generate --force
echo [HRIS] App key generated.

REM Run migrations
php artisan migrate --seed --force
echo [HRIS] Migrations complete.

REM Create storage link
php artisan storage:link --force
echo [HRIS] Storage link created.
...
echo [HRIS] Setup complete!
echo [HRIS] You can now access HRIS at http://localhost
echo [HRIS] Database password: %DB_PASS%
